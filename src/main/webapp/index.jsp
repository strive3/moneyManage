						...
						<div class="sidebar">
							<ul class="col-nav span3">
								...
								<li id="metrics" class="collapse">
									<ul>
										<li><a href="userlist.user"> <i
												class="pull-right icon-signal"></i>用户列表
										</a><a href="add_user.user"> <i class="pull-right icon-fire"></i>添加用户
										</a></li>
									</ul>
								</li>
								<!-- 类别管理  -->
								...
								<li id="bookmarks" class="collapse">
									<ul>
										<li><a href="add_root.category"> <i
												class="pull-right icon-plane"></i>添加根类别
										</a><a href="list.category"> <i
								...
								<li id="product" class="collapse">
									<ul>
										<li><a href="list.product"> <i
												class="pull-right icon-cog"></i>商品列表
										</a><a href="add_product.product"> <i class="pull-right icon-fire"></i>添加商品
										</a>
										<a href="complex_search.product"> <i class="pull-right icon-cog"></i>商品搜索（复杂）</a>
										</li>
									</ul>
								</li>
								<!-- 订单管理  -->
